...
parser = argparse.ArgumentParser('Convert CodeGen model to GPT-J')
parser.add_argument('--code_model', default='vblagoje/pipeline-generator-v2', help='Codegen model to convert')
parser.add_argument('--output_dir', help='Output directry for the converted model')
args = parser.parse_args()

print(f'Loading CodeGen model {args.code_model}')
